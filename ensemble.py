...
if __name__ == "__main__":
    ...
    if arg.joint_motion_dir is not None and arg.bone_motion_dir is not None:
        # arg.alpha = [0.603, 0.9999, 0.448, 0.22]  Top1 Acc: 89.8643%
        
        # arg.alpha = [0.614, 0.9999, 0.42, 0.22]         Top1 Acc: 89.8721% XSub NTU 120\
        
        # arg.alpha = [0.6238, 0.9999 , 0.423, 0.219]     Top1 Acc: 90.9225% Xset NTU 120\
        
        # arg.alpha = [0.7, 0.9999 , 0.423, 0.219 ]     Top1 Acc: 92.6124% Xsub NTU 60\
        
        arg.alpha = [0.8, 0.4, 0.2, 0.9]
